...
export default function RequisitionNew() {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: RequisitionFormValues) => {
      ...
      const requisitionNumber = `REQ-${year}-${randomNum}`;
      
      return apiRequest("POST", "/api/requisitions", {
        ...data,
        requisitionNumber,
        status: "draft",
      });
    ...
    onSuccess: async (response) => {
      ...
      toast({ title: "Requisition Created", description: "The new requisition has been created." });
      const newReq = await response.json();
      navigate(`/requisitions/${newReq.id}`);
    },
    onError: () => {
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="Brief description of what you need" data-testid="input-title" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea {...field} rows={4} placeholder="Detailed description of the purchase request..." data-testid="input-description" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>If known, select the vendor</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Estimated total cost</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea {...field} rows={3} placeholder="Any additional notes for approvers..." data-testid="input-notes" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  <Button type="button" variant="outline" className="w-full" onClick={() => navigate("/requisitions")}>
              ...
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  <p>1. Create requisition (Draft)</p>
                  <p>2. Submit for approval</p>
                  <p>3. Manager reviews and approves/rejects</p>
                  <p>4. If approved, convert to Purchase Order</p>
                </CardContent>
              </Card>
            </div>
          </div>
